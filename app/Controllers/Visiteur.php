...
class Visiteur extends BaseController
{
    ...
    public function se_connecter()
    {
        ...
        $allowed = $throttler->check('connexion', 25, HOUR);
        ...
        if (!$this->validate($rules, $messages)) {
            ...
            if(!$allowed){
                $data['TitreDeLaPage'] = "Trop de requête,";
                $data['dureeRestante'] = "attendez ".strval($throttler->getTokenTime()).' seconde avant de recommencer';
            }
        } else {
            $modelCli = new ModeleClient();
            ...
            if (!$UtilisateurRetourne == null) {
                ...
                if ($MdP == $UtilisateurRetourne["MOTDEPASSE"] && $allowed) {
